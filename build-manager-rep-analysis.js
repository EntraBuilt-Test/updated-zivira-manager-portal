      ...
      <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-slate-50/80 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 text-[11px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Representative</th>
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-center text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Doctors Visited</th>
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-center text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Total Visits</th>
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-center text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Joint Visits (With You)</th>
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-center text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Joint Visit %</th>
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-center text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Supervision Status</th>
                <th className="py-3.5 px-4 font-bold text-slate-700 dark:text-white text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Last Joint Call</th>
                <th className="py-3.5 pr-4 pl-2 text-right text-slate-500 dark:text-white bg-slate-50 dark:bg-slate-900">Actions</th>
              </tr>
            </thead>
...
fs.writeFileSync('C:/Users/ELCOT/Downloads/Zivira-Manager-main/components/manager-rep-analysis.tsx', fileContent, 'utf8');
console.log('Successfully wrote manager-rep-analysis.tsx');
